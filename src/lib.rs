...
#[derive(Debug)]
pub struct CyberNationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CyberNationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CyberNation processing");
    
    let mut processor = CyberNationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CyberNationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CyberNationProcessor::new(false);
